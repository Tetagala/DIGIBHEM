...
let price=document.getElementById("price");
     ...
     frequentitems.forEach(frequent => {
      frequent.addEventListener('click', function handleClick() {
        ...
        if(frequent.src=="https://m.media-amazon.com/images/I/61-xhMpd8iL._AC_SY200_.jpg")
        {
          producttitle.innerHTML="Casaliving Rolando Wood 4 Seater L Shape Sofa for Living Room with 2 Puffy ...";
        ...
        else if(frequent.src=="https://m.media-amazon.com/images/I/71CVv+-eVWL._UY500_.jpg")
        {
          producttitle.innerHTML="TIMEWEAR Analog New Track Number Dial Day Date Functioning Leather Strap Watch for Men";
        ...
        else if(frequent.src=="https://m.media-amazon.com/images/I/81-u+xYNpIL._SL1500_.jpg")
        {
          producttitle.innerHTML="LuvLap Sunshine Baby Stroller / Pram for 0 to 3 Years, New Born / Toddler / Kid, 5 Point Safety Harness, Adjustable backrest, 360° Swivel Wheel, Large...)";
        ...
        else if(frequent.src=="https://m.media-amazon.com/images/I/51jCZU4McCL._SL1080_.jpg")
        {
          producttitle.innerHTML="Pigeon by Stovekraft Hard Anodised Aluminium Pressure Cooker Combo - 2 L, 3 L and 5 L Induction Base Outer Lid Cooker (14414, Black)";
          stars.innerHTML='<i class="bi bi-star-fill"><i class="bi bi-star-fill"><i class="bi bi-star-fill"><i class="bi bi-star-fill">';
            mrp.innerHTML=5799;
            price.innerHTML=2499;
        }
        ...
        else if(frequent.src=="https://encrypted-tbn3.gstatic.com/shopping?q=tbn:ANd9GcS2xRMZBrp-bTFZOBKVdJi3_7kXDJ5_FmFMVUjc_o7C_9kMmqC49e8MhaJlQz8t012NWuewnsoR3q7_LI6Fq4f8yIWDANdqHu4g8TVVkm3m26T0DgFESpAu&usqp=CAE")
        {
          producttitle.innerHTML="Borosil Best Mixer Grinder";
        ...
        else if(frequent.src=="https://m.media-amazon.com/images/I/31UISB90sYL._SL1022_.jpg")
        {
          ...
          stars.innerHTML='<i class="bi bi-star-fill"><i class="bi bi-star-fill"><i class="bi bi-star-fill"><i class="bi bi-star-fill"><i class="bi bi-star-fill">';
            mrp.innerHTML=46999;
            price.innerHTML=32539;
        }
        else if(frequent.src=="https://m.media-amazon.com/images/I/81Qbpm1X04L._UY741_.jpg")
        {
          producttitle.innerHTML="Safari Polycarbonate Soft 59 Cms Suitcase(Thorsharpanti554Wblk_Black)";
          stars.innerHTML='<i class="bi bi-star-fill"><i class="bi bi-star-fill"><i class="bi bi-star-fill"><i class="bi bi-star-fill"><i class="bi bi-star-fill">';
            mrp.innerHTML=7999;
            price.innerHTML=4499;
        }
        else if(frequent.src=="https://m.media-amazon.com/images/I/91QDbyL02eL._UY741_.jpg")
        {
          producttitle.innerHTML="Aaparam Fashion Women's Jacquard Art Silk Saree With Unstiched Blouse Piece";
          stars.innerHTML='<i class="bi bi-star-fill"><i class="bi bi-star-fill"><i class="bi bi-star-fill"><i class="bi bi-star-fill"><i class="bi bi-star-fill">';
            mrp.innerHTML=3999;
            price.innerHTML=2500;
        }
        else if(frequent.src=="https://encrypted-tbn2.gstatic.com/shopping?q=tbn:ANd9GcSQtzk51dZdelzHTW5TfX2uggjkN0SyYrDdWami53hoSO7QUvrv2m8__AKe4pSum3n9S_x2RnlpB8NNAi941Veus1_HD9dl&usqp=CAE")
        {
          producttitle.innerHTML="Modern soffa for more comfort";
          stars.innerHTML='<i class="bi bi-star-fill"><i class="bi bi-star-fill"><i class="bi bi-star-fill"><i class="bi bi-star-fill"><i class="bi bi-star-fill">';
            mrp.innerHTML=9999;
...
let image="https://www.kiranaworld.in/Admin/Slider/Desktop/3014651.jpg";
let ttl="kitchen oils";
let price=1499;
addtocarteachitem(image,ttl,price);
}
function bacimg2()
{
window.alert("added to cart (Cart items number should not be increases)");
let image="https://images-eu.ssl-images-amazon.com/images/G/31/img21/Wireless/Shreyansh/BAU/Unrexc/D70978891_INWLD_BAU_Unrec_Uber_PC_Hero_3000x1200._CB594707876_.jpg";
...
{
window.alert("added to cart (Cart items number should not be increases)");
let image="https://images-eu.ssl-images-amazon.com/images/G/31/IMG19/Furniture/Beds/PC/Beds_Web_01._CB464037068_.jpg";
